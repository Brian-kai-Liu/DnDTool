...
namespace Launcher
{
    public class LoadTipsUI : UIBase
    {
        ...
        private TextMeshProUGUI m_textConfirm;
        private Button m_btnUpdate;
        private TextMeshProUGUI m_textUpdate;
        private Button m_btnCancel;
        private TextMeshProUGUI m_textCancel;

        protected override void ScriptGenerator()
        {
            m_textDesc = FindChildComponent<TextMeshProUGUI>("BgImage/m_textDesc");
            m_btnConfirm = FindChildComponent<Button>("BgImage/ButtonGroup/m_btnConfirm");
            m_textConfirm = FindChildComponent<TextMeshProUGUI>("BgImage/ButtonGroup/m_btnConfirm/m_textConfirm");
            m_btnUpdate = FindChildComponent<Button>("BgImage/ButtonGroup/m_btnUpdate");
            m_textUpdate = FindChildComponent<TextMeshProUGUI>("BgImage/ButtonGroup/m_btnUpdate/m_textUpdate");
            m_btnCancel = FindChildComponent<Button>("BgImage/ButtonGroup/m_btnCancel");
            m_textCancel = FindChildComponent<TextMeshProUGUI>("BgImage/ButtonGroup/m_btnCancel/m_textCancel");
